      ...
      restRecomm = (
        <div>
          ...
          <Typography variant="subtitle1" gutterBottom>
            <b>Recommendations for {this.state.username}</b>
          </Typography>
          <div style={{ marginLeft: "650px" }}>
            <List>
              {recommendations.map((recommend, index) => (
                <ListItem key={index}>{recommend}</ListItem>
              ))}
            </List>
          </div>
        </div>
      ...
      <React.Fragment>
        ...
        <div className="moveCentre">
          <form noValidate autoComplete="off">
            ...
            <br />
            <br />
            <InputLabel id="demo-simple-select-label">Filtering</InputLabel>
            <Select
